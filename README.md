...
```
5. Go to [https://github.io/kietpawpan/encryption](https://github.io/kietpawpan/encryption])and paste the cipher text into the cipher text input box.
6. Type the secret key in the secret key input box. Then, click the Decrypt button.
7. 7. Items and prices are top secret data, encrypted with an external encryption program, decrypted and evaluated oninput to be the variable value:
```
